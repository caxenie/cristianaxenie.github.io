...
**Cristian Axenie** is a **Steering Committee Member** of the **AI Impact Initiative, AI4GOOD** of the [International Telecommunications Union (**ITU**) and United Nations (**UN**)](https://aiforgood.itu.int/speaker/cristian-axenie/). At the same time, he is **Member** of the [**Open Neuromorphic**](https://open-neuromorphic.org/contributors/cristian-axenie/) Community, **Invited Speaker** of the [**Alan Turing Institute**](https://www.turing.ac.uk/people/guest-speakers/cristian-axenie) in the UK, and Member of the AI Commons Working Group at [**Centre Leo Apostel (CLEA), Vrije Universiteit Brussel (VUB)**](https://clea.research.vub.be/aic) supporting the **awareness**, **acceptance**, and **adoption** of neuromorphic AI technologies in the industrial context and their impact.
